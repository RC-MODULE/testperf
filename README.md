...
## Подготовка хэдеров с прототипами тестируемых функций

Все тестируемые функции должны быть описаны с помощью тегов Doxygen в хэдерах.
...
1. *--path\_to_inc* - путь к папке с хэдерами, в которых описаны функции в формате Doxygen.
