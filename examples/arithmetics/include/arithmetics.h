...
\param  x [in] входной вектор комплексных чисел (мнимая и действительная части имеют тип float)
\retval X [out] выходной вектор комплексных чисел (мнимая и действительная части имеют тип float)
...
\xmlonly
	<testperf>
		 <param name=" pSrcVec1 "> im1 im2 </param>
		<init>
		     printf("Dummy init code-scenario 1\n");
		 </init>
